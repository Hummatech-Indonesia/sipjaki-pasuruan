...
barChartColors &&
    ((options = {
        ...
        dataLabels: { enabled: !1 },
        series: [
            { data: [380, 430, 450, 475, 550, 584, 780, 1100, 1220, 1365,1000,500] },
        ],
...
donutChartColors &&
    ((options = {
        ...
        series: [44, 55], // Update the series array with only 2 values
        labels: ["Sudah Mengisi ", "Belum Mengisi"], // Update the labels array with 2 labels
