...
interface ProjectInterface extends CountInterface, GetInterface, StoreInterface, CustomPaginationInterface, DeleteInterface, UpdateInterface, ShowInterface, SearchInterface
{
    /**
