...
class ProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'physical_progress' => 'nullable|numeric|between:0,100',
            'finance_progress' => 'nullable|numeric|between:0,100',
    ...
    public function messages(): array
    {
        return [
            ...
            'physical_progress.numeric' => 'Progress fisik harus berupa angka',
            'physical_progress.between' => 'Progress fisik harus diantara 0 hingga 100',
            'finance_progress.numeric' => 'Progress fisik harus berupa angka',
            'finance_progress.between' => 'Progress fisik harus diantara 0 hingga 100',
