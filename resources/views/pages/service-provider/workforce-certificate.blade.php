...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="">
            <a href="@role('superadmin|admin') {{ route('detail.service.provider',['service_provider' => $worker->serviceProvider->id]) }} @else {{route('workers.index')}}@endrole" class="btn me-2 btn-md btn-warning text-white cursor-pointer">
