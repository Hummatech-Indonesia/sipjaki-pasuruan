                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            @endforelse
                                ...
                                <tr>
                                    <td>Kontrak</td>
                                    <td><img src="{{ asset('storage/'. $project->contract) }}" alt="" style="width: auto" height="150"></td>
                                </tr>
                                <tr>
                                    <td>report</td>
                                    <td><img src="{{ asset('storage/'. $project->report) }}" alt="" style="width: auto" height="150"></td>
                                </tr>
                                <tr>
                                    <td>minutes_of_disbursement</td>
                                    <td><img src="{{ asset('storage/'. $project->minutes_of_disbursement) }}" alt="" style="width: auto" height="150"></td>
                                </tr>
                                <tr>
                                    <td>administrative_minutes</td>
                                    <td><img src="{{ asset('storage/'. $project->administrative_minutes) }}" alt="" style="width: auto" height="150"></td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('service-provider-projects.store', ['project' => $project->id]) }}" method="post"
                    ...
                    @method('POST')
                    @else
                    <form action="{{ route('upload-file-consultan.update', ['project' => $project->id]) }}" method="post"
                        enctype="multipart/form-data">
                        @method('PUT')
                    @endif
