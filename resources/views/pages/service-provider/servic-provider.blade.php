                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn text-white btn-detail" id="{{ $serviceProvider->id }}" data-id="{{ $serviceProvider->id }}" style="background-color: #1B3061">
                                    Detail
                                </button>
                            </td>
                        </tr>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">JL. Harga Buah no 3</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">Malang</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">Jawa Timur</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">045641</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">084665412354</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">badanusaha23@gmail.com</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">www.badanusaha.com</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">CV. Badan Usaha</span></p>
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        <p class="mb-2 text-dark" style="font-weight:600;"><span
                                id="detail-birth_date" class="">Pelaksana Kegiatan Kerja</span></p>
                    </div>
                </div>
            </div>
