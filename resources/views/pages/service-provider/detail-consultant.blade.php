                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Kontrak</td>
                                    <td>:</td>
                                    <td><a href="" type="button" class="btn btn-md text-white"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3 ajax-select mt-3 mt-lg-0">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukkan Nama Paket" value="{{ old('date_start') }}"
                                        name="date_start" id="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 ajax-select mt-3 mt-lg-0">
                                    ...
                                    <input type="number" class="form-control" placeholder="Masukkan Nilai Kontrak" value="{{ old('date_finish') }}"
                                        name="date_finish" id="">
                                </div>
                            </div>
