                ...
                <table class="table mb-0 table-borderless" border="1">
                    <thead>
                        <tr>
                            ...
                            <th class="text-white" style="background-color: #1B3061">Nama Klasifikasi Pelatihan</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <div class="">
                                            <button type="button" data-id="{{ $classificationTraining->id }}"
                                                class="btn btn-danger btn-delete waves-effect waves-light btn-delete">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <td colspan="6" class="text-center">
                                    <div class="d-flex justify-content-center" style="min-height:16rem">
                                        <div class="my-auto">
                                            ...
                                            <h4 class="text-center mt-4">Kalsifikasi Pelatihan Kosong !!</h4>
                                        </div>
                                    </div>
                                </td>
                            </tr>
