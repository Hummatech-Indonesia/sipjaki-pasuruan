                    ...
                    <div class="avatar-sm mx-auto mb-4">
                        <div class="flex-shrink-0 align-self-center">
                            <div class="avatar-sm rounded-circle mini-stat-icon">
                                <span class="avatar-title rounded-circle ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 60 60" fill="none">
                                        <path d="M32.5 40C32.5 41.3807 31.3807 42.5 30 42.5C28.6193 42.5 27.5 41.3807 27.5 40C27.5 38.6193 28.6193 37.5 30 37.5C31.3807 37.5 32.5 38.6193 32.5 40Z" fill="white"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M18.9124 5.73223C19.3813 5.26339 20.0172 5 20.6802 5L39.3198 5C39.9828 5 40.6187 5.26339 41.0876 5.73223L54.2678 18.9124C54.7366 19.3813 55 20.0172 55 20.6802V39.3198C55 39.9828 54.7366 40.6187 54.2678 41.0876L41.0876 54.2678C40.6187 54.7366 39.9828 55 39.3198 55H20.6802C20.0172 55 19.3813 54.7366 18.9124 54.2678L5.73223 41.0876C5.26339 40.6187 5 39.9828 5 39.3198L5 20.6802C5 20.0172 5.26339 19.3813 5.73223 18.9124L18.9124 5.73223ZM21.7157 10L10 21.7157L10 38.2843L21.7157 50H38.2843L50 38.2843V21.7157L38.2843 10L21.7157 10ZM30 17.5C31.3807 17.5 32.5 18.6193 32.5 20V30C32.5 31.3807 31.3807 32.5 30 32.5C28.6193 32.5 27.5 31.3807 27.5 30V20C27.5 18.6193 28.6193 17.5 30 17.5Z" fill="white"/>
                                      </svg>
                                </span>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <div class="mini-stat-icon avatar-sm rounded-circle">
                            <span class="avatar-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 68 68" fill="none">
                                    <g clip-path="url(#clip0_468_5856)">
                                      <path d="M25.5 14.1667H19.8333C18.3304 14.1667 16.8891 14.7637 15.8264 15.8264C14.7636 16.8891 14.1666 18.3304 14.1666 19.8333V53.8333C14.1666 55.3362 14.7636 56.7776 15.8264 57.8403C16.8891 58.903 18.3304 59.5 19.8333 59.5H48.1666C49.6695 59.5 51.1109 58.903 52.1736 57.8403C53.2363 56.7776 53.8333 55.3362 53.8333 53.8333V19.8333C53.8333 18.3304 53.2363 16.8891 52.1736 15.8264C51.1109 14.7637 49.6695 14.1667 48.1666 14.1667H42.5" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M36.8333 8.5H31.1667C28.0371 8.5 25.5 11.0371 25.5 14.1667C25.5 17.2963 28.0371 19.8333 31.1667 19.8333H36.8333C39.9629 19.8333 42.5 17.2963 42.5 14.1667C42.5 11.0371 39.9629 8.5 36.8333 8.5Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M25.5 34H25.5271" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M36.8334 34H42.5" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M25.5 45.3333H25.5271" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M36.8334 45.3333H42.5" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                    ...
                    <div class="flex-shrink-0 mt-2">
                        <button class="btn btn-md rounded-3" style="background-color: #1B3061;color:white;width:100px;">Lihat</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <span class="avatar-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 68 68" fill="none">
                                    <g clip-path="url(#clip0_468_5930)">
                                      <path d="M25.5001 14.1667H19.8334C18.3305 14.1667 16.8892 14.7637 15.8265 15.8264C14.7638 16.8891 14.1667 18.3304 14.1667 19.8333V53.8333C14.1667 55.3362 14.7638 56.7776 15.8265 57.8403C16.8892 58.903 18.3305 59.5 19.8334 59.5H48.1667C49.6696 59.5 51.111 58.903 52.1737 57.8403C53.2364 56.7776 53.8334 55.3362 53.8334 53.8333V19.8333C53.8334 18.3304 53.2364 16.8891 52.1737 15.8264C51.111 14.7637 49.6696 14.1667 48.1667 14.1667H42.5001" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M36.8333 8.5H31.1667C28.0371 8.5 25.5 11.0371 25.5 14.1667C25.5 17.2963 28.0371 19.8333 31.1667 19.8333H36.8333C39.9629 19.8333 42.5 17.2963 42.5 14.1667C42.5 11.0371 39.9629 8.5 36.8333 8.5Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M39.6666 31.1667H32.5833C31.4561 31.1667 30.3751 31.6144 29.578 32.4115C28.781 33.2085 28.3333 34.2895 28.3333 35.4167C28.3333 36.5438 28.781 37.6248 29.578 38.4219C30.3751 39.2189 31.4561 39.6667 32.5833 39.6667H35.4166C36.5438 39.6667 37.6248 40.1144 38.4218 40.9115C39.2188 41.7085 39.6666 42.7895 39.6666 43.9167C39.6666 45.0438 39.2188 46.1248 38.4218 46.9219C37.6248 47.7189 36.5438 48.1667 35.4166 48.1667H28.3333" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M34 28.3333V31.1667M34 48.1667V51V48.1667Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                            ...
                            <span class="avatar-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 68 68" fill="none">
                                    <g clip-path="url(#clip0_468_6103)">
                                      <path d="M34 22.6655V33.9988L39.6667 39.6655" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M8.6416 31.1677C9.27653 24.9346 12.184 19.1533 16.8093 14.927C21.4347 10.7006 27.4541 8.32507 33.7191 8.25351C39.9841 8.18195 46.0562 10.4194 50.7768 14.539C55.4975 18.6586 58.5363 24.3719 59.3134 30.589C60.0905 36.806 58.5516 43.0916 54.9903 48.2464C51.4289 53.4012 46.0944 57.0645 40.0046 58.5373C33.9147 60.0101 27.4958 59.1893 21.9724 56.2316C16.4491 53.2738 12.208 48.3862 10.0583 42.5011M8.6416 56.6677V42.5011H22.8083" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                        ...
                        <div class="mini-stat-icon avatar-sm rounded-circle">
                            <span class="avatar-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 50 50" fill="none">
                                    <path d="M46.875 48.4375H4.6875C3.8587 48.4375 3.06384 48.1083 2.47779 47.5222C1.89174 46.9362 1.5625 46.1413 1.5625 45.3125V3.125C1.5625 2.7106 1.72712 2.31317 2.02015 2.02015C2.31317 1.72712 2.7106 1.5625 3.125 1.5625C3.5394 1.5625 3.93683 1.72712 4.22985 2.02015C4.52288 2.31317 4.6875 2.7106 4.6875 3.125V45.3125H46.875C47.2894 45.3125 47.6868 45.4771 47.9799 45.7701C48.2729 46.0632 48.4375 46.4606 48.4375 46.875C48.4375 47.2894 48.2729 47.6868 47.9799 47.9799C47.6868 48.2729 47.2894 48.4375 46.875 48.4375Z" fill="white"/>
                                    <path d="M15.2344 42.1875H11.3281C10.3957 42.1875 9.50151 41.8171 8.8422 41.1578C8.1829 40.4985 7.8125 39.6043 7.8125 38.6719V23.8281C7.8125 22.8957 8.1829 22.0015 8.8422 21.3422C9.50151 20.6829 10.3957 20.3125 11.3281 20.3125H15.2344C16.1668 20.3125 17.061 20.6829 17.7203 21.3422C18.3796 22.0015 18.75 22.8957 18.75 23.8281V38.6719C18.75 39.6043 18.3796 40.4985 17.7203 41.1578C17.061 41.8171 16.1668 42.1875 15.2344 42.1875Z" fill="white"/>
                                    ...
                                    <path d="M43.3242 42.1875H39.418C38.4856 42.1875 37.5914 41.8171 36.932 41.1578C36.2727 40.4985 35.9023 39.6043 35.9023 38.6719V12.8906C35.9023 11.9582 36.2727 11.064 36.932 10.4047C37.5914 9.7454 38.4856 9.375 39.418 9.375H43.3242C44.2566 9.375 45.1508 9.7454 45.8101 10.4047C46.4694 11.064 46.8398 11.9582 46.8398 12.8906V38.6719C46.8398 39.6043 46.4694 40.4985 45.8101 41.1578C45.1508 41.8171 44.2566 42.1875 43.3242 42.1875Z" fill="white"/>
                                  </svg>
                            </span>
                        </div>
                        ...
                        <div class="mini-stat-icon avatar-sm rounded-circle">
                            <span class="avatar-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 46 46" fill="none">
                                    <path d="M7.6665 40.2504V26.8337" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.66675 19.1667V5.75" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M23 40.25V23" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M23 15.3333V5.75" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M38.3335 40.2496V30.6663" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M38.3333 23V5.75" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M1.9165 26.8337H13.4165" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M17.25 15.3337H28.75" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M32.5835 30.6663H44.0835" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                  </svg>
                            </span>
                        </div>
