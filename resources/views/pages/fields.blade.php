            ...
            <div class="modal fade" id="modal-create" tabindex="-1" id="modal-create" aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="form-create" action="{{ route('fields.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="create-name" class="form-control"
                                        name="name" aria-describedby="name" placeholder="Masukkan Nama Bidang" />
                                </div>
                            </div>
            ...
            <table class="table table-borderless" border="1">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #1B3061;color:#ffffff">Nama Bidang</th>
                        ...
                        <tr>
                            ...
                            <td class="d-flex flex-row gap-3 justify-content-center">
                                <button type="button"
                                    ...
                                    id="btn-edit-{{ $field->id }}" data-id="{{ $field->id }}"
                                    data-name="{{ $field->name }}"><i class="bx bx-bx bxs-edit fs-4"></i>
                                ...
                                <button type="button"
                                    ...
                                    data-id="{{ $field->id }}" data-bs-toggle="modal" data-bs-target="#modal-delete"><i
                            ...
                            <td colspan="3" class="text-center">
                                <div class="d-flex justify-content-center" style="min-height:16rem">
                                    <div class="my-auto">
                                        ...
                                        <h4 class="text-center mt-4">Nama Bidang Kosong!!</h4>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
@section('script')
    <script>
        $('.btn-edit').click(function() {
            ...
            var actionUrl = `fields/${formData['id']}`;
