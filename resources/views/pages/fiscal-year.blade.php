...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-between mb-3">
            <div>
                <h5>
                    Berikut daftar Jenjang KKNI Kualifikasi
                </h5>
            </div>
            <div>
                    ...
                    <form id="form-create">
                        <div class="modal-header d-flex align-items-center">
                            <h4 class="modal-title" id="exampleModalLabel1">
                                Tambah Jenjang KKNI Kualifikasi
                            </h4>
                        ...
                        <div class="modal-body">
                            <form id="form-create" method="POST">
                                <div class="mb-3">
                                    <label id="name" for="recipient-name" class="control-label mb-2">Masukan Jenjang KKNI Kualifikasi</label>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #1B3061;color:#ffffff">Nama Jenjang KKNI Kualifikasi</th>
