    ...
    <div class="card p-3">
        ...
        <div class="modal fade" id="modal-create" tabindex="-1" id="modal-create" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form id="form-create" action="{{ route('qualification-trainings.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="create-name" class="form-control"
                                    name="name" aria-describedby="name" placeholder="Masukkan Pelatihan Kualifikasi" />
                            </div>
                        </div>
        ...
        <div class="table-responsive">
            <table class="table table-borderless" border="1">
                ...
                <tbody>
                    @forelse ($qualificationTrainings as $index => $qualificationTraining)
                        <tr>
                            <td>{{ $index + 1 }}</td>
