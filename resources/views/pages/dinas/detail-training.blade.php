        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex justify-content-header gap-3">
                    ...
                    <div>
                        <a href="/print-training-member" target="_blank">
                    ...
                    <div>
                        <a href="/training-member-export" target="_blank">
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                      @if ($trainingMember->file)
                                      <a href="{{ asset('storage/' . $trainingMember->file) }}" target="_blank"
                                        download><button type="submit" class="btn text-white fw-normal"
