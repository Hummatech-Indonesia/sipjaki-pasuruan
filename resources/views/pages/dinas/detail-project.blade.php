            ...
            <table cellpadding="7" style="border-collapse: collapse;width:30%;" class="fs-6 fw-normal">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td id="detail-status">{{ $project->status == 'active' ? 'Aktif' : ($project->status == 'nonactive' ? 'Non-Aktif' : $project->status) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td id="detail-characteristic_project_name">{{ $project->characteristic_project == 'single' ? 'Tahun Tunggal' : ($project->characteristic_project == 'multiple' ? 'Tahun Jamak' : $project->characteristic_project) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
