                    ...
                    @forelse ($serviceProviders as $serviceProvider)
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('detail.service.provider', ['service_provider' => $serviceProvider->id]) }}"
                            ...
                            <td colspan="6" class="text-center">
                                <div class="d-flex justify-content-center" style="min-height:16rem">
                                    <div class="my-auto">
                                        ...
                                        <h4 class="text-center mt-4">Penyelenggara Kosong!!</h4>
                                    </div>
                                </div>
                            </td>
                        </tr>
        ...
        function deleteSelected() {
            ...
            if (selectedIds) {
                ...
                Swal.fire({
                    'icon': 'error',
                    'title': 'error',
                    'text': 'Setidaknya Pilih Satu Akun Pelaksana Untuk Dihapus'
                })
            }
        }
