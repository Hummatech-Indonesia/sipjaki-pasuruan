                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="create-name" class="form-control"
                                    name="name" aria-describedby="name" placeholder="Masukkan Kualifikasi" />
                            </div>
                        </div>
                    ...
                    @forelse ($qualifications as  $qualification)
                        <tr>
                            ...
                            <td class="d-flex flex-row gap-3 justify-content-center" style="border-bottom: 1px solid #fff">
                                <a href="{{ route('qualifications.show', $qualification->id) }}" type="button"
                                    class="btn  waves-effect waves-light text-white" style="background-color: #1B3061">
