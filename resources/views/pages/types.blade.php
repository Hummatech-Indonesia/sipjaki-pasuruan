    ...
    <div class="card p-3">
            ...
            <div class="modal fade" id="modal-create" tabindex="-1" id="modal-create" aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="form-create" action="{{ route('types.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="create-name" class="form-control"
                                        name="name" aria-describedby="name" placeholder="Masukkan Type" />
                                </div>
                            </div>
        ...
        <div class="table-responsive">
            <table class="table table-borderless" border="1">
                ...
                <tbody>
                    @forelse ($types as $index => $section)
                        <tr>
...
@section('script')
    <script>
        $('.btn-edit').click(function() {
            ...
            var actionUrl = `types/${formData['id']}`;
