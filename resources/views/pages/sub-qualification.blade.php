...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="mb-3">
            <a href="{{ route('qualifications.index') }}" class="btn me-2 btn-md btn-warning text-white cursor-pointer">
    ...
    <div class="modal fade" id="samedata-modal" tabindex="-1" id="modeal-create" aria-labelledby="exampleModalLabel1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('qualifications.level.store', ['qualification' => $qualification->id]) }}"
                    method="post">
                    @csrf
                    @method('POST')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <div class="btn me-2 btn-md btn-create text-white" data-bs-toggle="modal" data-bs-target="#samedata-modal"
