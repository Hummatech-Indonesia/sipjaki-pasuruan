                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="my-auto">
                                ...
                                <div>
                                    ...
                                    <p style="color: #1B3061">Masukkan Email Anda dan instruksi akan dikirimkan kepada Anda!</p>
                                </div>
                                ...
                                <div class="mt-4">
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="email"
                                                class="form-label" style="font-weight: bold">{{ __('Alamat Email') }}</label>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p>Sudah ingat? <span style="color: #457DFF">Login</span></a> </p>
                                    </div>
                                </div>
                            </div>
