                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card overflow-hidden">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-dark p-4">
                                        <h5 class="text-dark" style="font-weight: 600">Reset Password</h5>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="alert alert-info text-center mb-4" role="alert"> Silahkan Masukkan password
                                baru anda
                            </div>
                            <div class="p-2">
                                <form class="needs-validation" novalidate action="{{ route('reset.passsword.user', $Id) }}"
                                    ...
                                    @method('PUT')
                                    <div class="mb-3">
                                        <label for="useremail" class="form-label">Passowrd baru</label>
                                        <input type="password" name="password" class="form-control" id="useremail"
                                    ...
                                    <div class="mb-3">
                                        <label for="username" class="form-label">Konfirmasi passowrd</label>
                                        <input type="password" name="password_confirmation" class="form-control"
                                            id="username" placeholder="Enter Konfirmasi Password" required>
